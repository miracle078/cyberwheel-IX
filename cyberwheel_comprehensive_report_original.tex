...
\begin{center}
 {\LARGE Reinforcement Learning for Adaptive Cyber Defense: \\ PPO-Based Decoy Deployment Optimization Using Cyberwheel} \\ 
 \vspace{0.5cm}
 {\large A Comprehensive Experimental Analysis of Defensive Strategy Learning in Cybersecurity}
\end{center}

\begin{abstract}
We present a comprehensive experimental investigation into reinforcement learning-based cyber defense optimization using the Cyberwheel cybersecurity simulation environment. Building upon the existing Cyberwheel framework developed by prior researchers, this thesis focuses on training and evaluating PPO-based blue agents for adaptive decoy deployment in realistic network defense scenarios. Our research addresses the critical challenge of optimizing defensive strategies against sophisticated cyber threats through systematic experimental analysis and comprehensive baseline comparisons. Through rigorous experimental methodology involving multiple network configurations and statistical validation, we demonstrate the effectiveness of learned defensive policies compared to traditional static and rule-based approaches. Our experimental contributions include comprehensive baseline algorithm comparison framework, quantified performance analysis of PPO-based defensive strategies, and validated effectiveness across different network configurations. Key findings demonstrate PPO's strategic learning capabilities, superior consistency compared to random baselines, and practical applicability for real-world cyber defense deployment.
\end{abstract}
...
\begin{itemize}
\item \textbf{PPO Strategic Learning}: Demonstrates superior consistency (σ=28.28) compared to random approach (σ=76.87)
