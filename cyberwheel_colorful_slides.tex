...
% Logo
\logo{\includegraphics[height=0.8cm]{/rds/general/user/moa324/home/projects/cyberwheel/research_docs/poster/Images/ICL_Logo_Blue_RGB.pdf}\hspace{0.2cm}}
...
\titlepage
\begin{center}
    \textcolor{ImperialBlue}{\large miracle.akanmode24@imperial.ac.uk}
\end{center}
\end{frame}
...
\foreach \pos/\year in {0/1990s - 2000s, 4.5/2000s - 2010s, 9/2010s - Present} {
...
\begin{tikzpicture}[scale=0.8]
    ...
    \addplot[color=ImperialBlue, mark=square, line width=2pt] coordinates {
        (15, 309.14)
        (50, 325.42)
        (200, 298.17)
    };
    \addlegend{PPO Performance}
